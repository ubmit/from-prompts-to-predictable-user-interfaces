...
<div class="flex flex-col justify-center h-full px-16">
  ...
  <div class="text-4xl font-semibold text-white mb-16 text-center">
...
<div class="flex flex-col justify-center h-full px-20 py-8">
  ...
  <v-click>
    <div class="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6 mb-6">
      ...
      <div class="text-lg text-gray-300">Design contracts, feedback loops, structured formats</div>
    </div>
  </v-click>
  ...
  <v-click>
    <div class="bg-green-500/10 border border-green-500/30 rounded-lg p-6 mb-6">
      ...
      <div class="text-lg text-gray-300">Figma MCP for design, /agent-browser for validation, json-render for UI</div>
    </div>
  </v-click>
